...
public class PhotonFusionService : INetworkRunnerCallbacks
{
    ...
    public static PhotonFusionService Instance => _instance ??= new PhotonFusionService();
    private static PhotonFusionService _instance;

    private PhotonFusionService()
    {
        _instance = this;
    }
