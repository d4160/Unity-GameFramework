...
namespace d4160.UGS.Authentication
{
    public static class AuthManager
    {
        ...
        public static void Login(IAuthService authService) {
            ...
            if(IsLoggedOn){
                LoggerM31.LogWarning("You are already logged on.", LogLevel);
                return;
            }
        ...
        public static void Register(IAuthService authService) {
            ...
            if(IsSignedUp){
                LoggerM31.LogWarning("You are already signed up.", LogLevel);
                return;
            }
        ...
        public static void Logout() {
            ...
            if(IsNotAuthenticated){
                LoggerM31.LogWarning("You are not authenticated.", LogLevel);
                return;
            }
