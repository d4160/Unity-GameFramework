...
namespace d4160.AWS.Cognito
{
    ...
    public class ResendConfirmationCodeRequestSO : ScriptableObject
    {
        ...
        public ResendConfirmationCodeRequest GetRequest(bool forceCreateNew = false, bool updateAttributes = true)
        {
        ...
        public async Task<ResendConfirmationCodeResponse> ResendConfirmationCodeAsync(bool forceCreateNewClient = false, bool forceCreateNewRequest = false, bool updateAttributes = true)
        {
            return await _client.GetClient(forceCreateNewClient).ResendConfirmationCodeAsync(GetRequest(forceCreateNewRequest, updateAttributes));
        }
    }
}