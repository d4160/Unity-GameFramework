...
{
    public abstract class UnityObjectList<T> : UnityObjectList, IList<T> where T : Object//, IObjectData
    {
        [BoxGroup("List")]
        ...
        public T AddObject(Vector3 position, Quaternion rotation, Transform parent = null, bool worldPositionStays = true)
        {
        ...
        public T AddOrUpdateObject(Vector3 position, Quaternion rotation, Transform parent = null, bool worldPositionStays = true)
        {
            T item;
