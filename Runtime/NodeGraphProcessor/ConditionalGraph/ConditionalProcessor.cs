...
namespace d4160.NodeGraphProcessor
{
    public class ConditionalProcessor : BaseGraphProcessor
    {
        ...
        protected Dictionary<BaseNode, List<BaseNode>>    nonConditionalDependenciesCache = new Dictionary<BaseNode, List<BaseNode>>();

        public bool             pause;

        public IEnumerator<BaseNode> currentGraphExecution { get; protected set; } = null;
        ...
        protected void WaitedRun(Stack<BaseNode> nodesToRun)
        {
        ...
        protected IEnumerable<BaseNode> GatherNonConditionalDependencies(BaseNode node)
        {
        ...
        protected IEnumerator<BaseNode> RunTheGraph()
        {
        ...
        protected IEnumerator<BaseNode> RunTheGraph(Stack<BaseNode> nodeToExecute)
		{
